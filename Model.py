...
class Model:
    ...
    def __init__(self, dimension, f_dim, f_out_size, item_n, batch_size=100, hide_size=100, out_size=100, step=1,
                 alpha=0.1, beta=0.1):
    ...
    def forward(self, re_embeddings, train=True):
        ...
        :return:
        """
        # 选取每个session第t-1个隐藏层参数。。
        re_embeddings = tf.stack(
...
class GGNN(Model):
    ...
    def gnn(self):
        # 匹配session中的向量，embeddings里的嵌入会更新吗？？
